window.addEventListener("DOMContentLoaded", () => {
  const projects = [
    {
      ...
      featuredImg: "./image/popup-img.png",
      technologies: ["css", "html", "bootstrap", "ruby"],
      demoLink: "https://dunnyk.github.io/personal-portfolio/",
      projectLink: "https://github.com/dunnyk/personal-portfolio",
    },
    {
  ...
  popupOpenButton.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      closeImage.src = "./image/cross.png";
      ...
      seeSourceImg.src = "./image/github.png";
